...
var parse = function parse(result) {
  ...
  $("<img id='logo' src='/twitterlogoblue.png'/>").insertAfter(result.find('.account-group')); // result.find('.account-group').after(twitterLogo);
...
//# sourceMappingURL=index.js.c5286e39744f4fa2c0f2.hot-update.js.map