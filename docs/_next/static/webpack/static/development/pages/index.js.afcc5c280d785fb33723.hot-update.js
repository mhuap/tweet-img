...
var parse = function parse(result) {
  ...
  $("<img id='logo' src='/twitterlogoblue.png'/>").insertAfter(accountInfo); // result.find('.account-group').after(twitterLogo);
...
//# sourceMappingURL=index.js.afcc5c280d785fb33723.hot-update.js.map