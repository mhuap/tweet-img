...
stage:3}]];}async function getPostCssPlugins(dir){let config=await(0,_findConfig.findConfig)(dir,'postcss');if(config==null){config={plugins:getDefaultPlugins()};}// Warn user about configuration keys which are not respected
